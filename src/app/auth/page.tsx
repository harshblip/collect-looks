...
export default function Auth() {
  ...
  const mode =
    useAppSelector((state) => state.utility.mode) || "Create an account";
        ...
        <div className="md:p-32 flex flex-col items-center p-24">
          ...
          {loginStatus ? (
            <motion.p
              ...
              className="font-product mt-12 text-4xl text-secondary"
            >
              {" "}
              Hey {euid.username} 👋
            </motion.p>
            ...
            <>
              ...
              >
                ...
                <div className="ml-6 flex flex-col space-y-2">
                  ...
                  <code>"password": "kpvaG4gRG9lIiwiYWRtW4iOnRydWU"</code>
                </div>
                <code>{"}"}</code>
              </motion.div>
              <div className="mt-4 flex justify-center text-secondary">
                <p>
                  ...
                  <button
                    ...
                    className="hover:shadow-md border border-gray-400 rounded-md p-2 items-center ml-2 mr-2 hover"
                  >
                    {" "}
