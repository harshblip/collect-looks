    ...
    <>
        ...
        >
          <div className="bg-white bg-[url('/sample-bg.png')] bg-center bg-contain p-6 rounded-lg flex flex-col justify-center text-primary">
            {created ? (
              <p className="text-xl"> folder {name} created ✅ </p>
            ) : (
              <>
                <p className="flex items-start text-2xl mt-2">
                  {" "}
                  Create a new folder{" "}
                </p>
                <hr className="w-32 border-[0.14rem] border-gray-400 rounded-full mt-2" />
                ...
                <div
                  className={`flex ${locked ? `flex-col` : `flex-row`} items-center space-x-2`}
                >
                  {locked && (
                    <div className="flex flex-col space-y-2 mt-4">
                  ...
                  <div className="flex justify-center w-full items-center space-x-2 mt-4">
                    ...
                    <div className={`${locked && `flex space-x-2`}`}>
                      ...
                      <Checkbox setChecked={setLocked} />
                    </div>
                  </div>
                </div>
                <div
                  className={`flex justify-around w-full items-center ${locked ? `mt-6` : `mt-16`}`}
                >
                  <button
