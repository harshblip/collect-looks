  ...
  return (
    <>
      ...
      >
        ...
        >
          <p className="flex justify-center text-gray-600 text-2xl mt-4 font-medium">
            {" "}
            Advanced search{" "}
          </p>
          <div className="flex flex-col space-y-6 p-4 mt-4 text-md">
            <div className="text-primary flex flex-col space-y-2 justify-between">
              <p> Filter by type </p>
              <div
                className={`transition text-gray-600 items-center flex space-x-4 font-pixel`}
              >
                <button
                  onClick={() =>
                    setFilters((fil) => ({
                ...
                >
                  <PhotoIcon width={20} className="mr-2" />
                  image
                </button>
                <button
                  onClick={() =>
                ...
                >
                  <PlayIcon width={20} className="mr-2" />
                  video
                </button>
                <button
                  onClick={() =>
                ...
                >
                  <SignalIcon width={20} className="mr-2" />
                  audio
                </button>
                <button
                  onClick={() =>
                ...
                >
                  <DocumentDuplicateIcon width={20} className="mr-2" />
                  document
                </button>
              </div>
            </div>
            ...
            <div className="text-primary flex justify-between items-center">
              <p> Date </p>
              <div>
                <Calendar29 setFilters={setFilters} />
              </div>
            </div>
            {showInfo && (
              <div className="p-3 w-full rounded-md bg-gray-100 flex space-x-4 items-center">
                <SparklesIcon width={20} className="text-secondary" />
                <p className="text-sm text-secondary">
                  try using natural language, like <i>tomorrow</i>,{" "}
                  <i>next week</i> to set dates
                </p>
                <button onClick={() => setShowInfo(false)} className="hover">
                  <XMarkIcon width={20} className="text-secondary -mt-6 ml-4" />
                </button>
              </div>
            )}
            <button
