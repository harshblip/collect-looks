import { AllFiles, Files } from "@/types/mediaTypes";
import { BASE_URL } from "@/lib/constants";
import axios from "axios";

export async function fetchAllFiles(user_id: string): Promise<AllFiles[]> {
...
export async function getStarFile(userId: string): Promise<AllFiles[]> {
