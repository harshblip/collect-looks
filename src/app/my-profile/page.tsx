  ...
  return (
    <>
      <AnimatePresence>
        ...
        >
          <ProfileNavbar />
          <p className="font-glook z-20 mt-[14rem] text-primary text-5xl ml-12">
            {" "}
            Hey,&nbsp;{data?.username[0].toUpperCase()}
          ...
          <div className="mt-10 flex justify-center items-center space-x-8 z-20">
            <PuzzlePieceIcon className="w-6 text-gray-400" />
            <hr className="w-24 border-2 border-gray-300" />
            <p className={`font-pixel text-secondary text-xl`}>
              Account
            </p>
            <hr className="w-24 border-2 border-gray-300" />
            <PuzzlePieceIcon className="w-6 text-gray-400" />
          ...
          <div className="flex flex-col items-center justify-center w-full">
            <div className="bg-white w-[90rem] rounded-lg p-4 mt-12">
              {data && (
                <AccountInfo username={data.username} email={data.email} />
              )}
            </div>
            <div className="bg-white w-[90rem] rounded-lg p-4 mt-12">
              <StorageInfo
