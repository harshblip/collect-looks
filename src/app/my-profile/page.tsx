import { ArrowRightIcon, InformationCircleIcon, LockClosedIcon, PhotoIcon, PuzzlePieceIcon } from "@heroicons/react/24/solid";
...
export default function MyProfile() {
    ...
    return (
        <>
            <div className="p-4 flex flex-col font-product primary-bg h-full">
                <ProfileNavbar />
